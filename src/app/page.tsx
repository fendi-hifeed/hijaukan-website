  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white pt-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-center lg:text-left space-y-6">
                ...
                <div className="flex flex-wrap gap-3 justify-center lg:justify-start pt-4">
                  ...
                  <a
                    href="https://drive.google.com/file/d/1Ye0hKt18yO4uBmUfNDayvSZ0qCnsAiAn/view?usp=sharing"
                    target="_blank"
        ...
        {/* SECTION 2: PANTAU DAMPAK NYATA KAMI */}
        <section className="py-16 px-4 bg-hijaukan-dark">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              ...
              <div className="bg-white/10 backdrop-blur rounded-2xl p-6">
                <p className="text-xs text-white/70 uppercase tracking-wide mb-2">RESTORASI LAHAN</p>
              ...
              <div className="bg-white/10 backdrop-blur rounded-2xl p-6">
                <p className="text-xs text-white/70 uppercase tracking-wide mb-2">KAMI TELAH MENYERAP</p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-hijaukan-green text-white rounded-2xl p-6">
                ...
                <p className="text-white/90 text-sm">
                  {locale === 'id'
                    ? '1 bibit leguminosa, biaya tanam dan perawatan selama 1 tahun'
                    : '1 leguminosa seedling, planting and care costs for 1 year'}
                </p>
              </div>
              <div className="bg-hijaukan-green text-white rounded-2xl p-6">
                ...
                <p className="text-white/90 text-sm">
                  {locale === 'id'
                    ? 'Setiap hektar leguminosa mampu menyerap hingga 20 ton CO₂ per tahun!'
                    : 'Each hectare of leguminosa can absorb up to 20 tons of CO₂ per year!'}
                </p>
              </div>
              <div className="bg-hijaukan-green text-white rounded-2xl p-6">
        ...
        {/* Programs Section: Jajan Karbon, Eco-Carbon Reserve, SustainaTree */}
        <ProgramsSection />

        {/* SECTION 4: Map Monitoring (lokasi aksi) */}
        <section className="py-16 px-4 bg-hijaukan-dark">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="rounded-2xl overflow-hidden shadow-2xl">
              <iframe
                src="https://www.google.com/maps?q=-5.680975,105.60938&z=17&hl=en&output=embed"
                width="100%"
                height="500"
                style={{ border: 0 }}
                allowFullScreen
