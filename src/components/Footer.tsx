            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-lg font-semibold text-hijaukan-green mb-4">
                            Care to Grow: <span className="text-transparent bg-clip-text bg-gradient-to-r from-hijaukan-green to-hijaukan-dark">Simple, Practical, and Powerful</span>
                        </p>
                        <p className="text-gray-600 leading-relaxed mb-6">
                            {locale === 'id'
                                ? 'Gerakan restorasi lahan kritis bersama komunitas dan mitra.'
                                : 'Critical land restoration movement together with communities and partners.'}
                        </p>
                        <div className="space-y-1 text-sm">
                            <div className="font-semibold text-hijaukan-dark">{locale === 'id' ? 'Organisasi' : 'Organization'}</div>
                            <div>Yayasan Langkah Restorasi Bumi Indonesia</div>
                            <div className="flex items-center gap-4 mt-3">
                                <a href="https://www.instagram.com/kitahijaukan" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-gray-600 hover:text-hijaukan-green transition-colors">
                                    ...
                                    <span>@kitahijaukan</span>
                                </a>
                                <a href="https://www.linkedin.com/company/hijaukanx" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-gray-600 hover:text-hijaukan-green transition-colors">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="border-t border-gray-200 mt-12 pt-8">
                    <div className="text-center md:text-left">
                        <p className="text-gray-500">&copy; {new Date().getFullYear()} KitaHijaukan - Yayasan Langkah Restorasi Bumi Indonesia. {t('copyright') as string}</p>
                    </div>
                </div>
            </div>
        </footer>
