...
const ProgramsSection: React.FC = () => {
  ...
  const programs: ProgramCard[] = locale === 'id' 
    ? [
        {
          id: 'jajan-karbon',
          title: 'Jajan Karbon',
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-6">
          {programs.map((program) => (
            <div
              key={program.id}
              className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 flex flex-col"
            >
